  ...
  return (
    <div className='flex flex-col justify-center items-center my-20'>
        <div className='hidden lg:block'>
            <Image src='/profile1.png' width={100} height={100} alt='profile1'
            className='h-[100px] object-cover rounded-full absolute right-36'/>
             <Image src='/profile3.png' width={100} height={100} alt='profile2'
            className='h-[100px] object-cover rounded-full absolute top-48 left-16'/>
             <Image src='/profile2.png' width={100} height={100} alt='profile3'
            className='h-[100px] object-cover rounded-full absolute bottom-20 left-36'/>
              <Image src='/profile2.png' width={100} height={100} alt='profile4'
